defmodule ConfigsExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ConfigsExampleWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ConfigsExampleWeb.Gettext, "errors", msg, opts)
    # end
